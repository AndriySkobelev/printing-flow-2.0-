...
const QUICK_NOTES: Record<LogType, string[]> = {
  ...
  defect_sewing: ['Крива строчка', 'Не той розмір', 'Відсутня деталь'],
...
type Props = {
  maxQuantity: number
  actionSubmit: (values: PackingLogFormValues) => void
}

// ─── Component ───────────────────────────────────────────────────────────────

export const PackingLogForm = ({ maxQuantity, actionSubmit }: Props) => {
